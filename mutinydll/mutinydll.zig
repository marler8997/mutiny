...
const bootstrap_window_class_name = "MutinyBootstrapWindow";
...
fn MutinyMain(context: ?*anyopaque) callconv(.winapi) u32 {
...

    {
        const wc: win32.WNDCLASSEXW = .{
            ...
            .hbrBackground = null,
            .lpszMenuName = null,
            .lpszClassName = win32.L(bootstrap_window_class_name),
            .hIconSm = null,
        };
    ...
    const hwnd = win32.CreateWindowExW(
        .{},
        win32.L(bootstrap_window_class_name),
        null,
        .{},
        0,
        0,
    ...
    while (true) {
        ...
        if (result == 0) {
            std.log.err("ignoring WM_QUIT: detach is not supported", .{});
            continue;
        }
